...
public static class Mediumshiper
{
    ...
    public static bool MsMsg(PlayerControl pc, string msg)
    {
        ...
        bool ans;
        if (msg.Contains("n") || msg.Contains("N") || msg.Contains("no") || msg.Contains(GetString("No")) || msg.Contains("错") || msg.Contains("不是")) ans = false;
        else if (msg.Contains("y") || msg.Contains("yes") || msg.Contains("Y") || msg.Contains(GetString("Yes")) || msg.Contains("对")) ans = true;
        else
        {
